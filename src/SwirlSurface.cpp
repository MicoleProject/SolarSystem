...
#include <SwirlSurface.h>

using namespace Reachin;

const Interface SwirlSurface::interface(
	"SwirlSurface", 
	typeid(SwirlSurface), 
	Create<SwirlSurface>::create, 
	exposedField( "strength", &SwirlSurface::power),
	&ImageSurface::interface
	//	&SimpleSurface::interface
);
